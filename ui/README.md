...
`/polarion/aad-synchronizer-app/ui/app/`. The Maven build (frontend-maven-plugin +
maven-resources-plugin) runs this automatically and copies the bundle into
`src/main/resources/webapp/aad-synchronizer-app/app`, where `AADSynchronizerAppServlet` serves it at
`/polarion/aad-synchronizer-app/ui/app/index.html`.
